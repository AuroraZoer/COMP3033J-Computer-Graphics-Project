...
public class JumpHuman {
    ...
    public void DrawHuman(float delta, Texture faceTexture, Texture chestTexture, Texture pelvisTexture, float facing) {
        ...
        GL11.glPushMatrix();
        {
            ...
            GL11.glRotatef((LimbRotation / 10), 1.0f, 0.0f, 0.0f);
            ...
            GL11.glPushMatrix();
            {
                ...
                GL11.glPushMatrix();
                {
                    ...
                    GL11.glPushMatrix();
                    {
                        ...
                        GL11.glRotatef((LimbRotation + 30) / 3, 0, 0, 1.0f);
                        ...
                        GL11.glPushMatrix();
                        {
                            ...
                            GL11.glPushMatrix();
                            {
                                ...
                                {
                                    GL11.glTranslatef(0.0f, 0.0f, 0.0f);
                                    GL11.glRotatef(-(LimbRotation + 30) * 2 / 5, 0.0f, 1.0f, 0.0f);
                ...
                GL11.glPushMatrix();
                {
                    ...
                    GL11.glPushMatrix();
                    {
                        GL11.glTranslatef(0.0f, 0.0f, 0.0f);
                        GL11.glRotatef(90.0f, 1.0f, 0.0f, 0.0f);
                        GL11.glRotatef(15 + 15f * -LimbRotation / 45f, 1f, 0, 0);
                        cylinder.DrawCylinder(0.15f, 0.7f, 32);
                        ...
                        GL11.glPushMatrix();
                        {
                            ...
                            {
                                GL11.glTranslatef(0.0f, 0.0f, 0.0f);
                                GL11.glRotatef(-30 + 15f * LimbRotation / 45f, 1f, 0, 0);
                                cylinder.DrawCylinder(0.1f, 0.6f, 32);
